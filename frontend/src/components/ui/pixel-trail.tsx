// ABOUTME: Interactive mouse-trail grid effect using animated pixel dots.
// ABOUTME: Dots illuminate along cursor path and decay, creating a redaction-metaphor trail.
...
const PixelTrail: React.FC<PixelTrailProps> = ({
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      if (pixelElement) {
        const animatePixel = (
          pixelElement as HTMLDivElement & {
            __animatePixel?: () => void;
          }
        ).__animatePixel;
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: decorative mouse-trail effect, not semantic interaction
    <div
      ref={containerRef}
