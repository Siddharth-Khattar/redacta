// ABOUTME: Hook for detecting responsive breakpoints matching Tailwind defaults.
// ABOUTME: Returns a ComparableScreenSize with comparison methods like lessThan/greaterThan.
